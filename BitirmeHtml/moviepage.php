...
<div class="margin" >               <h2><?php echo $result1['tagline'] ?></h2>  
    	...
    	<form action="vote.php" method="post">           
            <button type="submit" name = "req5" value = <?php echo $result1['title'] ?>/>Add Watched List</button>
            </form>
      </div>                
    <?php endif; ?>
    ...
    <?php if($cond==0): ?>
      ...
      <form action="addmoviestowatch.php" method="post">           
            <button type="submit" name = "reqwatch" value = <?php echo $result1['title'] ?>/>Add Movies to Watch List</button>
            </form>
      </div>  
    ...
    <?php endif; ?>
      ...
      <div class="margin"> 
      <form action="vote.php" method="post">           
            <button type="submit" name = "reqchange" value = <?php echo $result1['title'] ?>/>Change Vote</button>
      ...
      <div class="margin"> 
      <form action="vote.php" method="post">           
            <button type="submit" name = "reqmark" value = <?php echo $result1['title'] ?>/>Mark as Watched</button>
            </form>
      </div>  
    ...
    <!--  <?php 
        ...
        $getid= mysqli_query($conn,"SELECT id FROM movietable WHERE title='$title'");
       ...
       while($row = $sorgu1->fetch_assoc()) : ?>
            ...
            <button style="width: 200px;" type="submit" name = "movietitle" class="rem" value = <?php echo '"'.$row['user_movie'].'"' ?>  /> <?php echo $row['user_movie'] ?> </button>
            </form>
              <form action="removemovie.php" method="post" >          
            <button style="width: 30px;" type="submit" name = "movietitle"  value = <?php echo '"'.$row['user_movie'].'"' ?> /> X </button>
            </form>
            <?php endwhile;
